...
public class AlunoTest {
   ...
   private static final String[][] parameters = {
         { "Juliana Cintra", "546.212.310-81", "1010-100", "Ativo" },
         { "Mallu Estácio", "546.212.310-81", "1010-200", "Ativo" },
         { "Thays Soares", "546.212.310-81", "1010-300", "Inativo" }
   };
   ...
   void testAtualizarCadastroAluno() {
      ...
      requestBody = "{\"nome\": \"Juliana Cintra\", \"cpf\": \"546.212.310-81\"}";
      response = given()
            .header("Content-type", "application/json")
            .and().body(requestBody).when()
            .put("/alunos/1010-100")
