   ...
   var t = function (t, e, a, o, s) {
      ...
      if (i) {
         var l = {
            ...
            plotOptions: {
               bar: { horizontal: !1, columnWidth: ["40%"], borderRadius: 4 },
            },
            legend: { show: !1 },
   ...
   return {
      init: function () {
         ...
         !(function () {
            ...
            t(
               "#kt_stats_widget_2_tab_2",
               "#kt_stats_widget_2_chart_2",
               [35, 60, 35, 50, 45, 30],
               [65, 80, 50, 80, 75, 105],
               !1
            ),
            t(
               "#kt_stats_widget_2_tab_3",
               "#kt_stats_widget_2_chart_3",
               [25, 40, 45, 50, 40, 60],
               [76, 85, 101, 98, 87, 105],
               !1
            ),
            t(
               "#kt_stats_widget_2_tab_4",
               "#kt_stats_widget_2_chart_4",
               [50, 35, 45, 55, 30, 40],
               [76, 85, 101, 98, 87, 105],
               !1
            ),
            ...
            (e = document.querySelector("#kt_forms_widget_1_form")) &&
            e &&
